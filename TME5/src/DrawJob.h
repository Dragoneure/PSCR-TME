...
DrawJob(int * x, int *y, Color *pixels, Scene scene, vector<Vec3D> lights, const Scene::screen_t & screen) : x(x),y(y),pixels(pixels),scene(scene),lights(lights), screen(screen){}
